...
description: 自媒体短视频全自动生产线 v11.3（最新：四大源头控制原则、视频≥3秒图片≤5秒、音频完整性优先、字幕单行规范、生产即验收）。从选题研究、网感文案撰写、TTS配音、真实素材准备、Ken Burns动画视频合成、封面设计到云盘上传的全流程自动化。支持8种稳态Ken Burns动画效果、字幕配音完美同步、真实截图优先规则。适用于每日短视频内容批量生产（抖音、小红书、视频号）。触发场景：每日视频、日更短视频、自媒体内容创作、视频流水线、批量生产视频、产品宣传视频、AI配音视频。
---
